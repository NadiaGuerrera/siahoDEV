    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-2"> 
        ...
        <div class="card mb-2" style="border: 1px solid #002c00;">
          <div class="row mb-1 p-3 pt-1 pb-2" style="color: #632a00; ">
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
              <label class="form-label mt-2">Fecha del Diagnóstico</label>
        ...
        <div class="card mb-2" style="border: 1px solid #002c00;">
          <div class="row mb-1 p-3 pt-1 pb-2" style="color: #632a00">
            <div class="col-xs-12 col-sm-12 col-md-6">
              <label class="form-label mt-2">Aspectos a Evaluar</label>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
              <label class="form-label mt-2">Condiciones</label>              
...
</div><br/><br/><br/><br/><?PHP include( 'vistas/layouts/jsstartRegistro.php' ); 
